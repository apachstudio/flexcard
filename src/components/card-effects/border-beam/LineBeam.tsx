...
export function LineBeam({
  ...
  // The line palettes ship only for the stock variants — the local 'brand'
  // variant borrows mono's clean silver line, which reads as a polished shine.
  const lineVariant = variant === 'brand' ? 'mono' : variant;
